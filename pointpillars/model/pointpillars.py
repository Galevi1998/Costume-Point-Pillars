...
class PointPillars(nn.Module):
    def __init__(self,
        ...
        # anchors
        ranges = [
            [0.57, -14.46, 0.39, 30.31, 7.6, 1.96],   # Car
            [-0.29, -14.84, 0.28, 30.23, 13.18, 1.9], # Pedestrian
            [6.35, -9.59, 0.45, 30.02, -2.88, 1.67],  # Cyclist
            ]


        sizes = [
           [4.36, 2.36, 2.36],  # Car
           [1.20, 1.20, 2.00],  # Pedestrian
           [1.50, 2.50, 2.00]   # Cyclist
        ]
        rotations=[0, 1.57]
